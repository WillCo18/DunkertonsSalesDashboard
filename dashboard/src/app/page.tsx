...
import { NewCustomersList, NewCustomersRecentList, AtRiskCustomersList, GapAnalysisPanel, EnhancedGapAnalysis, CrossProductGapAnalysis } from '@/components/insights'
